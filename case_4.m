...
vc_InitialLocation = [center_x, center_y];  
...
%% 
% 
% videoFileName = 'robot_motion_video.avi';
...
%% 
    % define virtual center's linear velocity and angular velocity  
    if (i < 100)
        v = 0.3;
        omega = 0.0;
    ...
    % Get the virtual center's in the xy direction and angular velocity
