...
function [ v_a, w_a, pos_a] = updateAgentPosition_mcl(pos_a_mcl, pos_a, pos_v, target_distance_a, target_angle_a, d, k1, k2, sampleTime, vel_v, agent)
...
%                 w_a: angular velocity of the agent
    ...
    vel_a = derivative(agent, pos_a_mcl, [v_a w_a]);
